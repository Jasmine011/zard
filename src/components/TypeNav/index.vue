<template>
    <div class="typeNav">
        <div class="type-nav">
            <div class="container" @mouseleave="cleaveIndex" @mouseenter="enterShow">
                ...
                <transition name="sort">
                    ...
                    <div class="all-sort-list2" @click="toSearch">
                        <div class="item" v-for="(item,index) in BaseCategoryList" :key="item.categoryId">
